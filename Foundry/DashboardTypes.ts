...
export type LearnSettings = {
  Source: "github" | "local" | "both" | "oasst" | "oasst2" | "wikipedia" | "gsm8k";
  Query: string; // GitHub search query — or a language filter (oasst/oasst2/wikipedia) or split (gsm8k: train|test|all)
